...
// ===== 百分比 → PWM 映射 =====
//static uint16_t Motor_PercentToPWM(uint8_t percent)
//{
//    if(percent > 100) percent = 100;
//    return (percent * MOTOR_PWM_MAX) / 100;
//}

// ===== 控制函数 =====
//void Motor_Control(Motor_ID motor, Motor_Mode mode, uint8_t speed_percent)
//{
//    uint16_t pwm = Motor_PercentToPWM(speed_percent);

//    if (motor == MOTOR_LEFT) 
//    {
//        switch(mode)
//        {
//            case MOTOR_STOP_FREE:
//                GPIO_SetBits(MOTOR_EN_L_PORT, MOTOR_EN_L_PIN); 
//                TIM_SetCompare2(TIM8, 0);            // L1 (CH2)
//                TIM_SetCompare1(TIM8, 0);            // L2 (CH1)
//                break;
//            case MOTOR_BRAKE:
//                GPIO_ResetBits(MOTOR_EN_L_PORT, MOTOR_EN_L_PIN); 
//                TIM_SetCompare2(TIM8, MOTOR_PWM_MAX);  
//                TIM_SetCompare1(TIM8, MOTOR_PWM_MAX);  
//                break;
//            case MOTOR_FORWARD:
//                GPIO_ResetBits(MOTOR_EN_L_PORT, MOTOR_EN_L_PIN); 
...
//        {
//            case MOTOR_STOP_FREE:
//                GPIO_SetBits(MOTOR_EN_R_PORT, MOTOR_EN_R_PIN); 
//                TIM_SetCompare3(TIM8, 0);            // R1 (CH3)
//                TIM_SetCompare4(TIM8, 0);            // R2 (CH4)
//                break;
//            case MOTOR_BRAKE:
//                GPIO_ResetBits(MOTOR_EN_R_PORT, MOTOR_EN_R_PIN); 
//                TIM_SetCompare3(TIM8, MOTOR_PWM_MAX);  
//                TIM_SetCompare4(TIM8, MOTOR_PWM_MAX);  
//                break;
//            case MOTOR_FORWARD:
//                GPIO_ResetBits(MOTOR_EN_R_PORT, MOTOR_EN_R_PIN); 
